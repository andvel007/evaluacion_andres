        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link exact-active-class="active" to="/users" class="nav-link">Usuarios</router-link>
                    </li>   
                     <li class="nav-item">
                        <router-link exact-active-class="active" to="/devices" class="nav-link">Equipos</router-link>
                    </li> 
                     <li class="nav-item">
